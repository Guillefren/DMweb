...
public class RegistrarProducto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        seleccionadas = new javax.swing.JTable();
        ...
        seleccionadas.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane3.setViewportView(seleccionadas);
    ...
    private void confirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmarActionPerformed
        ...
        if ( cpe.existeProducto(Nombre, NumRef)) 
            JOptionPane.showMessageDialog(null, "Nombre o numero de referencia ya ingresado, corrija");
        else if(cats.isEmpty())
               JOptionPane.showMessageDialog(null, "Debe ingresar al menos una categoria"); 
            else
...
//Bloque try-catch para errores}*/
    ...
    private void AgregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AgregarMouseClicked
        ...
        modelo3.setColumnIdentifiers(new String[]{"Seleccionada"});
       

        for (int i = 0;i < cats.size();i++){
           modelo3.addRow(new Object[]{cats.get(i).GetNombre()});
       }
        seleccionadas.setModel(modelo3);
    ...
    private void EliminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EliminarMouseClicked
         ControladorCategoria ca = new ControladorCategoria();
        int fila = seleccionadas.getSelectedRow();
       ...
       cats.remove(fila);
        ...
        DefaultTableModel modelo = new DefaultTableModel();
                //seleccionadas.setModel(modelo);
         modelo.setColumnIdentifiers(new String[]{"Seleccionada"});
                
           for (int i = 0;i < cats.size();i++){
           modelo.addRow(new Object[]{cats.get(i).GetNombre()});
    ...
    private javax.swing.JTable seleccionadas;
